...
<div style="display: flex; align-items: flex-start; margin-bottom: 20px;">
  <img src="https://i.imgur.com/Ta78eAk.jpeg" alt="Luan Nascimento" style="width: 70px; height: 70px; border-radius: 50%; margin-right: 15px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
  <div>
    <div style="font-weight: bold;">
